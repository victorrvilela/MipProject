                    ...
                    <section className="cards-new">
                        ...
                        <form className="new">
                                <section className="campos">
                                    <input className="imput" placeholder="Digite o nome do novo Funcionário"/>
                                    <input className="imput" placeholder="Digite a matrícula do novo Funcionário"/>
                                    <input className="imput" placeholder="Digite o cargo do novo Funcionário"/>
                                    <label htmlFor="Lider">Selecione o lider do funcionário</label>
                                    <select id="Lider" name="Lider" className="imput">
                                        <option value="Lider1">1</option>
                                        <option value="Lider2">2</option>
                                        <option value="Lider3">3</option>
                                    </select>                                      
                                </section>
                                <section >
